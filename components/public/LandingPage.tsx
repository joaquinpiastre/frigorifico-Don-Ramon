      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.seccion}>
          ...
          <Text style={styles.parrafo}>
            ...
            vacuna, de cerdo y de toro de la mejor calidad. Trabajamos tanto la
            venta mayorista como el autoservicio, para que vecinos, comercios y
            restaurantes encuentren siempre el corte justo que necesitan, con la
            frescura y la atención de un negocio de confianza.
          </Text>
        </View>

        {/* Productos */}
        <View style={[styles.seccion, styles.seccionOscura]}>
          <Text style={[styles.seccionTitulo, styles.seccionTituloClaro]}>
            Nuestros productos
          </Text>
        ...
        <View style={styles.seccion}>
          ...
          <View style={styles.grid}>
            {BENEFICIOS.map((b) => (
              <View
                key={b.titulo}
                style={[styles.tarjetaClara, { width: ancho }]}
              >
